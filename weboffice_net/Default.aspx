...
<body style="text-align: left"> 
   ...
   <table style="width: 100%" border = "0" cellpadding="0" cellspacing="0">
       <tr>
          ...
          <input id="muban" type="button" value="模板管理" onclick="javascript:location.href='template_Default.aspx'"/>
          <br><br>
    ...
    <div style="color: red">
         ...
         <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/des.mdb"
            SelectCommand="SELECT top 15 [id], [DocID], [DocTitle], [DocType], [DocDate] FROM [Doc] order by id desc" DeleteCommand="delete * from Doc where id=0">
