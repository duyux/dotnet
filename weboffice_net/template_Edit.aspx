<%@ Page Language="C#" AutoEventWireup="true" CodeFile="template_Edit.aspx.cs" Inherits="DocEdit" %>
...
function WebOffice1_NotifyCtrlReady() {
	...
	{%>        
        document.all.WebOffice1.LoadOriginalFile("<%=URL %>/template_GetDoc.aspx?ID=<%=ID%>","<%=DocType%>");
...
//添加相应的Post元素
	...
	vtRet = document.all.WebOffice1.HttpPost("<%=URL %>/template_upload.aspx");
   ...
   <br /> <br />
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td rowspan="2">
	      ...
	      <input type="button" value="打开本地模板" onclick="return docOpen()" id="Button1" style="width: 115px" /></td>
    ...
    <tr bgcolor="#FFFFFF">
	  ...
	  <td colspan="4" valign="top" style="height: 560px">
		<!-- -----------------------------== 装载weboffice控件 ==----------------------------------->	  
